        ...
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="input-group">
                    ...
                    <input value="{{old('nome', !empty($tamanho->nome) ? $tamanho->nome : '')}}" type="text" name="nome" class="form-control @error('nome') is-invalid @enderror" placeholder="Nome da Categoria" id="_nome">
                    @error('nome')
        ...
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="input-group">
                    ...
                    <input value="{{old('sigla', !empty($tamanho->sigla) ? $tamanho->sigla : '')}}" type="text" name="sigla" placeholder="Siglas" class="form-control @error('sigla') is-invalid @enderror" id="_sigla" />
                    @error('sigla')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
