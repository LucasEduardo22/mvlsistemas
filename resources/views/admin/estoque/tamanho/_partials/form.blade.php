        ...
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="input-group">
                    ...
                    <input value="{{old('nome', !empty($tamanho->nome) ? $tamanho->nome : '')}}" type="text" name="nome" class="form-control @error('nome') is-invalid @enderror" placeholder="Nome da SubGrupo" id="_nome">
                    @error('nome')
