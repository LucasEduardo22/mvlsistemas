...
@section('content')
    ...
    <div class="card">
        ...
        <section class="content-header">  
            <h1 class="mt-2">Grupos<a href="{{route('grupo.create')}}" class="btn btn-info mb-5 pb-5 float-right"><i class="fas fa-plus-square"></i> ADICIONAR</a></h1>
        </section>
        ...
        <div class="card-body">
            <div class="col-md-12">
                <div class="table-responsive">
                    ...
                    @else
                        <h1>Ops ainda não foi cadastrado nenhuma grupo</h1>
                    @endif
                </div>
            </div>
        </div>
