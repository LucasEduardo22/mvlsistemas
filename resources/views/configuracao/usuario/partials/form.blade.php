...
<div class="form-row ml-3">
    <div class="form-group col-md-2">
        <input class="form-check-input" type="radio" name="_cnpj_cpf" id="_cnpj" value="0" checked>
        <label class="form-check-label" for="_cnpj">
            Pessoa Jurídica
        </label>
    </div>
    <div class="form-group col-md-2">
        <input class="form-check-input" type="radio" name="_cnpj_cpf" id="_cpf" value="1">
        <label class="form-check-label" for="_cpf">
            Pessoa Física 
        </label>
    </div>
</div>
...
<div class="form-row"> 
    <div class="form-group col-md-3 mb-3">
        <label for="_cnpj_cpf" id="situacao">CNPJ</label>
        <input type="text" name="cnpj_cpf" class="form-control @error('cnpj_cpf') is-invalid @enderror" id="_cnpj_cpf" 
        value="{{old('cnpj_cpf', !empty($fornecedor->cnpj_cpf) ? $fornecedor->cnpj_cpf : '')}}" placeholder="99.999.999/0000-00">
        @error('cnpj_cpf')
            <span class="invalid-feedback" role="alert">
                <strong>{{ $message }}</strong>
            </span>
